...
st.markdown(
        ...
        <ol style="text-align: right; direction: rtl;">
            <li>האם ישנם אזורים בישראל עם ריכוז יוצא דופן של מתקפות טרור בהשוואה לאחרים?</li>
            <li>קורלציה בין מספר המחבלים למספר הנפגעים: האם קיים קשר בין כמות המחבלים באירוע לכמות הנפגעים?</li>
            <li>מהם ההבדלים בין סוגי הנשק בתרומתם לחומרת האירועים (מספר נפגעים והרוגים) ותדירות האירועים מכל סוג נשק?</li>
        </ol>
        <div style="text-align: right; direction: rtl;">
        לכל אחת מהמטלות קיים עמוד נפרד בו נענה על השאלה באמצעות וויזואליזציה על הנתונים.
         <br>
        העמודים כוללים גרפים, טבלאות ומפות המציגים את הממצאים והמסקנות שלנו ונמצאים בתפריט בצד השמאלי של המסך.
        </div>
        ''',
        unsafe_allow_html=True
)
